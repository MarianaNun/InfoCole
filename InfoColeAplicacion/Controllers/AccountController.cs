...
namespace InfoColeAplicacion.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var urlactual = Request.UrlReferrer.ToString();
            @ViewBag.message = "¡Debe registrarse para crear un comentario!";
            @ViewBag.urlOrigen = urlactual;
            return View();
        }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    ...
                    //ViewBag.LoginProvider = "InfoCole";
                    //return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { Email = model.Email});
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, Habilitado = true };
